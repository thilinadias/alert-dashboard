<x-app-layout>
    ...
    <div>
        <div class="container-fluid">
            ...
            <div class="row g-4 mb-4">
                ...
                <!-- SLA Breaches -->
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('alerts.mine', ['sla' => 'overdue']) }}" class="text-decoration-none">
                        <div class="card shadow-sm border-0 border-start border-4 border-danger h-100 transition-transform hover-scale">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div>
                                    <div class="text-muted small fw-medium">My SLA Breaches</div>
            ...
            <div class="row g-4 mb-4">
                    ...
                    <div class="card shadow-sm border-0 h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="card-title fw-bold mb-0">My Workload</h5>
                                <span class="badge bg-light text-secondary border">Live Data</span>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <h6 class="text-center small fw-bold text-muted mb-2">Weekly Resolutions</h6>
                                    <div style="height: 200px;">
                                        <canvas id="weeklyChart"></canvas>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <h6 class="text-center small fw-bold text-muted mb-2">Assigned Alerts</h6>
                                    <div style="height: 200px;">
             ...
             <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h5 class="card-title fw-bold mb-4">My Recent Activity</h5>
    ...
    <!-- Additional Styles for Timeline alignment -->
    <style>
