        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.clients.update', $client) }}" method="POST" class="row g-3">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="email_domain" id="email_domain" class="form-control" value="{{ $client->email_domain }}">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="identifier_keywords" id="identifier_keywords" class="form-control" rows="2" placeholder="e.g. Acme, ACME-PROD, Project-X">{{ $client->identifier_keywords }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <select name="sla_policy_id" id="sla_policy_id" class="form-select">
                                ...
                                @foreach($slaPolicies as $policy)
                                    <option value="{{ $policy->id }}" {{ $client->sla_policy_id == $policy->id ? 'selected' : '' }}>
