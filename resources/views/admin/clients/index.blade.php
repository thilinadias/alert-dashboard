                        ...
                        <tbody>
                            @forelse($clients as $client)
                                <tr>
                                    ...
                                    <td>
                                        @if($client->slaPolicy)
                                            <span class="badge bg-info text-dark">{{ $client->slaPolicy->name }}</span>
                                        @else
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            ...
                                            <form action="{{ route('admin.clients.destroy', $client) }}" method="POST" onsubmit="return confirm('Are you sure? This action cannot be undone.');">
                                                @csrf
                                                @method('DELETE')
